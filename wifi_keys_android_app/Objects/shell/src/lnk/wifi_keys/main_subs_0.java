...
;
 BA.debugLineNum = 64;BA.debugLine="add_key_to_panel";
Debug.ShouldStop(-2147483648);
_add_key_to_panel();
 BA.debugLineNum = 65;BA.debugLine="send_state_timer.Initialize(\"send_state_timer\", 1";
Debug.ShouldStop(1);
main._send_state_timer.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("send_state_timer")),(Object)(BA.numberCast(long.class, 1000)));
 BA.debugLineNum = 66;BA.debugLine="send_state_timer.Enabled =True";
Debug.ShouldStop(2);
main._send_state_timer.runMethod(true,"setEnabled",main.mostCurrent.__c.getField(true,"True"));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e52) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e52.toString()); BA.debugLineNum = 68;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(8);
...
Debug.ShouldStop(4096);
try { BA.debugLineNum = 78;BA.debugLine="StateManager.SaveSettings";
Debug.ShouldStop(8192);
main.mostCurrent._statemanager.runVoidMethod ("_savesettings",main.mostCurrent.activityBA);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e62) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e62.toString()); BA.debugLineNum = 80;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(32768);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
Debug.ShouldStop(128);
 BA.debugLineNum = 73;BA.debugLine="add_key_to_panel";
Debug.ShouldStop(256);
_add_key_to_panel();
...
try {
		Debug.PushSubsStack("add_key_to_panel (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,170);
...
int _a = 0;
 BA.debugLineNum = 170;BA.debugLine="Sub add_key_to_panel() 'розміщення кнопок керуванн";
Debug.ShouldStop(512);
 BA.debugLineNum = 171;BA.debugLine="Try";
Debug.ShouldStop(1024);
try { BA.debugLineNum = 172;BA.debugLine="clear_keys";
Debug.ShouldStop(2048);
_clear_keys();
 BA.debugLineNum = 173;BA.debugLine="Dim vert_size As Int=StateManager.GetSetting2(\"v_";
Debug.ShouldStop(4096);
_vert_size = BA.numberCast(int.class, main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(BA.ObjectToString("v_size")),(Object)(RemoteObject.createImmutable(""))));Debug.locals.put("vert_size", _vert_size);Debug.locals.put("vert_size", _vert_size);
 BA.debugLineNum = 174;BA.debugLine="Dim horiz_size As Int=StateManager.GetSetting2(\"h";
Debug.ShouldStop(8192);
_horiz_size = BA.numberCast(int.class, main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(BA.ObjectToString("h_size")),(Object)(RemoteObject.createImmutable(""))));Debug.locals.put("horiz_size", _horiz_size);Debug.locals.put("horiz_size", _horiz_size);
 BA.debugLineNum = 175;BA.debugLine="Dim font_size As Int=StateManager.GetSetting2(\"fo";
Debug.ShouldStop(16384);
_font_size = BA.numberCast(int.class, main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(BA.ObjectToString("font_size")),(Object)(RemoteObject.createImmutable(""))));Debug.locals.put("font_size", _font_size);Debug.locals.put("font_size", _font_size);
 BA.debugLineNum = 176;BA.debugLine="Dim b_width,b_height,posx,posy,max_but As Int";
Debug.ShouldStop(32768);
...
_max_but = RemoteObject.createImmutable(0);Debug.locals.put("max_but", _max_but);
 BA.debugLineNum = 177;BA.debugLine="b_width=Activity.Width/horiz_size";
Debug.ShouldStop(65536);
_b_width = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main.mostCurrent._activity.runMethod(true,"getWidth"),_horiz_size}, "/",0, 0));Debug.locals.put("b_width", _b_width);
 BA.debugLineNum = 178;BA.debugLine="b_height=(Activity.height-20dip)/vert_size";
Debug.ShouldStop(131072);
_b_height = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._activity.runMethod(true,"getHeight"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))}, "-",1, 1)),_vert_size}, "/",0, 0));Debug.locals.put("b_height", _b_height);
 BA.debugLineNum = 179;BA.debugLine="max_but =horiz_size*vert_size";
Debug.ShouldStop(262144);
_max_but = RemoteObject.solve(new RemoteObject[] {_horiz_size,_vert_size}, "*",0, 1);Debug.locals.put("max_but", _max_but);
 BA.debugLineNum = 180;BA.debugLine="cur_but_state=0";
Debug.ShouldStop(524288);
main._cur_but_state = BA.numberCast(int.class, 0);
 BA.debugLineNum = 181;BA.debugLine="For a=1 To 32";
Debug.ShouldStop(1048576);
{
final int step11 = 1;
...
Debug.locals.put("a", _a);
 BA.debugLineNum = 182;BA.debugLine="If butstate(a)=True Then butt(a).Background=sld_";
Debug.ShouldStop(2097152);
...
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(false,"setBackground",(main.mostCurrent._sld_on.getObject()));};
 BA.debugLineNum = 183;BA.debugLine="If CM.toint(StateManager.GetSetting2(\"keytag\" &";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean(">",main.mostCurrent._cm.runMethod(true,"_toint",main.mostCurrent.activityBA,(Object)(main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(RemoteObject.concat(RemoteObject.createImmutable("keytag"),RemoteObject.createImmutable(_a))),(Object)(RemoteObject.createImmutable(""))))),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 184;BA.debugLine="If cur_but_state>=max_but Then Return";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("g",main._cur_but_state,BA.numberCast(double.class, _max_but))) { 
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 185;BA.debugLine="posy=cur_but_state/horiz_size";
Debug.ShouldStop(16777216);
_posy = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {main._cur_but_state,_horiz_size}, "/",0, 0));Debug.locals.put("posy", _posy);
 BA.debugLineNum = 186;BA.debugLine="posx=cur_but_state mod horiz_size";
Debug.ShouldStop(33554432);
_posx = RemoteObject.solve(new RemoteObject[] {main._cur_but_state,_horiz_size}, "%",0, 1);Debug.locals.put("posx", _posx);
 BA.debugLineNum = 187;BA.debugLine="butlock(a)=CM.obj2Bool(StateManager.GetSetting2";
Debug.ShouldStop(67108864);
main._butlock.setArrayElement (main.mostCurrent._cm.runMethod(true,"_obj2bool",main.mostCurrent.activityBA,(Object)((main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(RemoteObject.concat(RemoteObject.createImmutable("keylock"),RemoteObject.createImmutable(_a))),(Object)(BA.NumberToString(0)))))),BA.numberCast(int.class, _a));
 BA.debugLineNum = 188;BA.debugLine="butt(a).Text =StateManager.GetSetting2(\"keytext";
Debug.ShouldStop(134217728);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setText",(main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(RemoteObject.concat(RemoteObject.createImmutable("keytext"),RemoteObject.createImmutable(_a))),(Object)(RemoteObject.createImmutable("")))));
 BA.debugLineNum = 189;BA.debugLine="butt(a).tag =StateManager.GetSetting2(\"keytag\"";
Debug.ShouldStop(268435456);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(false,"setTag",(main.mostCurrent._statemanager.runMethod(true,"_getsetting2",main.mostCurrent.activityBA,(Object)(RemoteObject.concat(RemoteObject.createImmutable("keytag"),RemoteObject.createImmutable(_a))),(Object)(RemoteObject.createImmutable("")))));
 BA.debugLineNum = 190;BA.debugLine="butt(a).Left =posx*(b_width+1dip)";
Debug.ShouldStop(536870912);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {_posx,(RemoteObject.solve(new RemoteObject[] {_b_width,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))}, "+",1, 1))}, "*",0, 1));
 BA.debugLineNum = 191;BA.debugLine="butt(a).top =posy*(b_height+1dip)";
Debug.ShouldStop(1073741824);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setTop",RemoteObject.solve(new RemoteObject[] {_posy,(RemoteObject.solve(new RemoteObject[] {_b_height,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1)))}, "+",1, 1))}, "*",0, 1));
 BA.debugLineNum = 192;BA.debugLine="butt(a).width =b_width-2dip";
Debug.ShouldStop(-2147483648);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setWidth",RemoteObject.solve(new RemoteObject[] {_b_width,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "-",1, 1));
 BA.debugLineNum = 193;BA.debugLine="butt(a).height =b_height-2dip";
Debug.ShouldStop(1);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {_b_height,main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "-",1, 1));
 BA.debugLineNum = 194;BA.debugLine="butt(a).TextSize =font_size";
Debug.ShouldStop(2);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _a)).runMethod(true,"setTextSize",BA.numberCast(float.class, _font_size));
 BA.debugLineNum = 195;BA.debugLine="cur_but_state=cur_but_state+1";
Debug.ShouldStop(4);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e165.toString()); BA.debugLineNum = 199;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(64);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
try {
		Debug.PushSubsStack("clear_keys (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,85);
if (RapidSub.canDelegate("clear_keys")) return main.remoteMe.runUserSub(false, "main","clear_keys");
int _i = 0;
 BA.debugLineNum = 85;BA.debugLine="Sub clear_keys";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 86;BA.debugLine="Try";
Debug.ShouldStop(2097152);
try { BA.debugLineNum = 87;BA.debugLine="For i = 1 To 32";
Debug.ShouldStop(4194304);
{
final int step2 = 1;
final int limit2 = 32;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 88;BA.debugLine="butt(i).Left =-2000";
Debug.ShouldStop(8388608);
main.mostCurrent._butt.getArrayElement(false,BA.numberCast(int.class, _i)).runMethod(true,"setLeft",BA.numberCast(int.class, -(double) (0 + 2000)));
 BA.debugLineNum = 89;BA.debugLine="butt(i).Tag =\"\"";
Debug.ShouldStop(16777216);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e72.toString()); BA.debugLineNum = 93;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(268435456);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
try {
		Debug.PushSubsStack("get_rssi (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,148);
if (RapidSub.canDelegate("get_rssi")) return main.remoteMe.runUserSub(false, "main","get_rssi");
RemoteObject _data = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 148;BA.debugLine="Sub get_rssi() 'Відправка запиту на отримання рів";
Debug.ShouldStop(524288);
 BA.debugLineNum = 149;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 150;BA.debugLine="Dim Data As Map";
Debug.ShouldStop(2097152);
_data = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("Data", _data);
 BA.debugLineNum = 151;BA.debugLine="Data.Initialize";
Debug.ShouldStop(4194304);
_data.runVoidMethod ("Initialize");
 BA.debugLineNum = 152;BA.debugLine="Data.Put (\"rssi\",1)";
Debug.ShouldStop(8388608);
_data.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("rssi"))),(Object)(RemoteObject.createImmutable((1))));
 BA.debugLineNum = 153;BA.debugLine="CallSubDelayed2(Starter,\"send_to_dev\",Data)";
Debug.ShouldStop(16777216);
main.mostCurrent.__c.runVoidMethod ("CallSubDelayed2",main.mostCurrent.activityBA,(Object)((main.mostCurrent._starter.getObject())),(Object)(BA.ObjectToString("send_to_dev")),(Object)((_data)));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e124.toString()); BA.debugLineNum = 155;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(67108864);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
main._keys_is_load = RemoteObject.createImmutable(false);
...
public static RemoteObject  _reload_key_state(RemoteObject _mapar) throws Exception{
try {
		Debug.PushSubsStack("reload_key_state (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,115);
if (RapidSub.canDelegate("reload_key_state")) return main.remoteMe.runUserSub(false, "main","reload_key_state", _mapar);
RemoteObject _tmpid = RemoteObject.createImmutable(0);
Debug.locals.put("mapar", _mapar);
 BA.debugLineNum = 115;BA.debugLine="Sub reload_key_state(mapar As Map)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 116;BA.debugLine="Try";
Debug.ShouldStop(524288);
try { BA.debugLineNum = 117;BA.debugLine="Dim tmpid As Int";
Debug.ShouldStop(1048576);
_tmpid = RemoteObject.createImmutable(0);Debug.locals.put("tmpid", _tmpid);
 BA.debugLineNum = 118;BA.debugLine="tmpid=CM.toint(mapar.Get (\"rind\"))";
Debug.ShouldStop(2097152);
_tmpid = main.mostCurrent._cm.runMethod(true,"_toint",main.mostCurrent.activityBA,(Object)(BA.ObjectToString(_mapar.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("rind")))))));Debug.locals.put("tmpid", _tmpid);
 BA.debugLineNum = 119;BA.debugLine="If tmpid>0 Then";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean(">",_tmpid,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 120;BA.debugLine="If CM.toint(mapar.Get (\"rcom\"))=1 Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",main.mostCurrent._cm.runMethod(true,"_toint",main.mostCurrent.activityBA,(Object)(BA.ObjectToString(_mapar.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("rcom"))))))),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 121;BA.debugLine="butt(tmpid).Background =sld_on";
Debug.ShouldStop(16777216);
main.mostCurrent._butt.getArrayElement(false,_tmpid).runMethod(false,"setBackground",(main.mostCurrent._sld_on.getObject()));
 }else {
 BA.debugLineNum = 123;BA.debugLine="butt(tmpid).Background =sld_norm";
Debug.ShouldStop(67108864);
main.mostCurrent._butt.getArrayElement(false,_tmpid).runMethod(false,"setBackground",(main.mostCurrent._sld_norm.getObject()));
 };
 };
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e99) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e99.toString()); BA.debugLineNum = 127;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(1073741824);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
main.mostCurrent.__c.runVoidMethod ("CallSubDelayed2",main.mostCurrent.activityBA,(Object)((main.mostCurrent._starter.getObject())),(Object)(BA.ObjectToString("send_to_dev")),(Object)((_data)));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e229.toString()); BA.debugLineNum = 269;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(4096);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
try {
		Debug.PushSubsStack("send_comm (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,102);
...
Debug.locals.put("lock", _lock);
 BA.debugLineNum = 102;BA.debugLine="Sub send_comm(ind As Int,com As Boolean,lock As Bo";
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="Try";
Debug.ShouldStop(64);
try { BA.debugLineNum = 104;BA.debugLine="Dim Data As Map";
Debug.ShouldStop(128);
_data = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("Data", _data);
 BA.debugLineNum = 105;BA.debugLine="Data.Initialize";
Debug.ShouldStop(256);
_data.runVoidMethod ("Initialize");
 BA.debugLineNum = 106;BA.debugLine="Data.Put (\"ncom\",ind)";
Debug.ShouldStop(512);
_data.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("ncom"))),(Object)((_ind)));
 BA.debugLineNum = 107;BA.debugLine="Data.Put (\"com\",com)";
Debug.ShouldStop(1024);
_data.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("com"))),(Object)((_com)));
 BA.debugLineNum = 108;BA.debugLine="Data.Put (\"lock\",lock)";
Debug.ShouldStop(2048);
_data.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("lock"))),(Object)((_lock)));
 BA.debugLineNum = 109;BA.debugLine="CallSubDelayed2(Starter,\"send_to_dev\",Data)";
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("CallSubDelayed2",main.mostCurrent.activityBA,(Object)((main.mostCurrent._starter.getObject())),(Object)(BA.ObjectToString("send_to_dev")),(Object)((_data)));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e84) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e84.toString()); BA.debugLineNum = 111;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(16384);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
try {
		Debug.PushSubsStack("send_state_timer_Tick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,131);
if (RapidSub.canDelegate("send_state_timer_tick")) return main.remoteMe.runUserSub(false, "main","send_state_timer_tick");
 BA.debugLineNum = 131;BA.debugLine="Sub send_state_timer_Tick() ' таймер перевірки звя";
Debug.ShouldStop(4);
 BA.debugLineNum = 132;BA.debugLine="Try";
Debug.ShouldStop(8);
try { BA.debugLineNum = 133;BA.debugLine="If prs_but>0 Then send_comm(prs_but,True,False)";
Debug.ShouldStop(16);
...
_send_comm(main._prs_but,main.mostCurrent.__c.getField(true,"True"),main.mostCurrent.__c.getField(true,"False"));};
 BA.debugLineNum = 134;BA.debugLine="get_rssi";
Debug.ShouldStop(32);
_get_rssi();
 BA.debugLineNum = 135;BA.debugLine="If conect_tmout>0 Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean(">",main._conect_tmout,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 136;BA.debugLine="conect_tmout=conect_tmout-1";
Debug.ShouldStop(128);
main._conect_tmout = RemoteObject.solve(new RemoteObject[] {main._conect_tmout,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 137;BA.debugLine="If conect_tmout=0 Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",main._conect_tmout,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 138;BA.debugLine="status_lab.TextColor=Colors.Red";
Debug.ShouldStop(512);
main.mostCurrent._status_lab.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 BA.debugLineNum = 139;BA.debugLine="status_lab.Text = \"No connected\"";
Debug.ShouldStop(1024);
main.mostCurrent._status_lab.runMethod(true,"setText",RemoteObject.createImmutable(("No connected")));
 };
 };
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e114.toString()); BA.debugLineNum = 144;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(32768);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
public static RemoteObject  _set_ris(RemoteObject _rsi) throws Exception{
try {
		Debug.PushSubsStack("set_ris (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,159);
if (RapidSub.canDelegate("set_ris")) return main.remoteMe.runUserSub(false, "main","set_ris", _rsi);
Debug.locals.put("rsi", _rsi);
 BA.debugLineNum = 159;BA.debugLine="Sub set_ris(rsi As Int)";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 160;BA.debugLine="Try";
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 161;BA.debugLine="status_lab.TextColor=Colors.Green";
Debug.ShouldStop(1);
main.mostCurrent._status_lab.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 BA.debugLineNum = 162;BA.debugLine="status_lab.Text = \" RSSI: \" & rsi & \"dbm   Connec";
Debug.ShouldStop(2);
main.mostCurrent._status_lab.runMethod(true,"setText",(RemoteObject.concat(RemoteObject.createImmutable(" RSSI: "),_rsi,RemoteObject.createImmutable("dbm   Connected"))));
 BA.debugLineNum = 163;BA.debugLine="conect_tmout=3";
Debug.ShouldStop(4);
main._conect_tmout = BA.numberCast(int.class, 3);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e133) {
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e133.toString()); BA.debugLineNum = 165;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(16);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
main._butstate.setArrayElement (main.mostCurrent.__c.getField(true,"False"),_tmind);
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e204.toString()); BA.debugLineNum = 243;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(262144);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
...
main._prs_but = _tmind;
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e189.toString()); BA.debugLineNum = 227;BA.debugLine="proces_error(LastException.Message)";
Debug.ShouldStop(4);
_proces_error(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage"));
 };
