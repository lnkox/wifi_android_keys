...
try {
		Debug.PushSubsStack("proces_error (starter) ","starter",1,starter.processBA,starter.mostCurrent,232);
...
Debug.locals.put("msg", _msg);
 BA.debugLineNum = 232;BA.debugLine="Sub proces_error(msg As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 233;BA.debugLine="ToastMessageShow(msg,True)";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("send_to_dev (starter) ","starter",1,starter.processBA,starter.mostCurrent,188);
...
Debug.locals.put("data", _data);
 BA.debugLineNum = 188;BA.debugLine="Sub send_to_dev(data As Map) As Boolean ' Відправк";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 189;BA.debugLine="Try";
Debug.ShouldStop(268435456);
try { BA.debugLineNum = 190;BA.debugLine="Dim msg As String";
Debug.ShouldStop(536870912);
_msg = RemoteObject.createImmutable("");Debug.locals.put("msg", _msg);
 BA.debugLineNum = 191;BA.debugLine="Dim JSONGenerator As JSONGenerator";
Debug.ShouldStop(1073741824);
_jsongenerator = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator");Debug.locals.put("JSONGenerator", _jsongenerator);
 BA.debugLineNum = 192;BA.debugLine="data.Put (\"dev_name\",StateManager.GetSetting2(\"cu";
Debug.ShouldStop(-2147483648);
...
Debug.CheckDeviceExceptions();if (true) return _send_to_dev_udp(_msg);
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",starter.processBA, e169.toString()); BA.debugLineNum = 202;BA.debugLine="proces_error(LastException.Message & \"send_to_de";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("send_to_dev_mqtt (starter) ","starter",1,starter.processBA,starter.mostCurrent,206);
if (RapidSub.canDelegate("send_to_dev_mqtt")) return starter.remoteMe.runUserSub(false, "starter","send_to_dev_mqtt", _msg);
Debug.locals.put("msg", _msg);
 BA.debugLineNum = 206;BA.debugLine="Sub send_to_dev_mqtt(msg As String) As Boolean ' В";
Debug.ShouldStop(8192);
 BA.debugLineNum = 207;BA.debugLine="Try";
Debug.ShouldStop(16384);
try { BA.debugLineNum = 208;BA.debugLine="If objMqtt.isConnected =False Then Return False";
Debug.ShouldStop(32768);
...
Debug.CheckDeviceExceptions();if (true) return starter.mostCurrent.__c.getField(true,"False");};
 BA.debugLineNum = 209;BA.debugLine="objMqtt.Publish(\"wfkeyin\",msg,  objMqtt.QoS_Exact";
Debug.ShouldStop(65536);
...
Debug.CheckDeviceExceptions();if (true) return starter.mostCurrent.__c.getField(true,"True");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",starter.processBA, e178.toString()); BA.debugLineNum = 212;BA.debugLine="proces_error(LastException.Message & \"send_to_dev";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("send_to_dev_udp (starter) ","starter",1,starter.processBA,starter.mostCurrent,217);
...
Debug.locals.put("msg", _msg);
 BA.debugLineNum = 217;BA.debugLine="Sub send_to_dev_udp(msg As String) As Boolean ' Ві";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 218;BA.debugLine="Try";
Debug.ShouldStop(33554432);
try { BA.debugLineNum = 219;BA.debugLine="If UDPSocket.IsInitialized =False Then Return Fal";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",starter._udpsocket.runMethod(true,"IsInitialized"),starter.mostCurrent.__c.getField(true,"False"))) { 
Debug.CheckDeviceExceptions();if (true) return starter.mostCurrent.__c.getField(true,"False");};
 BA.debugLineNum = 220;BA.debugLine="Dim Packet As UDPPacket";
Debug.ShouldStop(134217728);
...
_packet.runVoidMethod ("Initialize",(Object)(_buffer),(Object)(BA.ObjectToString("255.255.255.255")),(Object)(BA.numberCast(int.class, RemoteObject.createImmutable("2201"))));
 BA.debugLineNum = 224;BA.debugLine="UDPSocket.Send(Packet)";
Debug.ShouldStop(-2147483648);
...
Debug.CheckDeviceExceptions();if (true) return starter.mostCurrent.__c.getField(true,"True");
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",starter.processBA, e192.toString()); BA.debugLineNum = 227;BA.debugLine="proces_error(LastException.Message & \"send_to_dev";
Debug.ShouldStop(4);
...
starter.mostCurrent._statemanager.runVoidMethod ("_savesettings",starter.processBA);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",starter.processBA, e152.toString()); BA.debugLineNum = 185;BA.debugLine="proces_error(LastException.Message & \"set_key_in";
Debug.ShouldStop(16777216);
