...
if (true) return _ser.runMethod(false,"ConvertBytesToObject",(Object)(_data));
...
if (true) return cm.mostCurrent.__c.getField(true,"False");};
...
if (true) return cm.mostCurrent.__c.getField(true,"True");
...
Debug.ShouldStop(8);
if (true) return _ser.runMethod(false,"ConvertObjectToBytes",(Object)(_obj));
