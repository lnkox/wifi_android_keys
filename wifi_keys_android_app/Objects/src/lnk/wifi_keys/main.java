...
_send_state_timer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
			...
			processBA.setLastException(e55); //BA.debugLineNum = 71;BA.debugLine="proces_error(LastException.Message)";
...
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
			...
			processBA.setLastException(e68); //BA.debugLineNum = 86;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
_cur_but_state = (int) (_cur_but_state+1);
			...
			processBA.setLastException(e176); //BA.debugLineNum = 214;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
mostCurrent._butt[_i].setTag((Object)(""));
			...
			processBA.setLastException(e78); //BA.debugLineNum = 99;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()),"send_to_dev",(Object)(_data));
			...
			processBA.setLastException(e119); //BA.debugLineNum = 152;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()),"send_to_dev",(Object)(_data));
			...
			processBA.setLastException(e243); //BA.debugLineNum = 288;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()),"send_to_dev",(Object)(_data));
			...
			processBA.setLastException(e90); //BA.debugLineNum = 117;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
mostCurrent._status_lab.setText((Object)("No connected"));
			...
			processBA.setLastException(e105); //BA.debugLineNum = 136;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
_conect_tmout = (int) (3);
			...
			processBA.setLastException(e144); //BA.debugLineNum = 180;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
_butstate[_tmind] = anywheresoftware.b4a.keywords.Common.False;
			...
			processBA.setLastException(e218); //BA.debugLineNum = 262;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
_prs_but = _tmind;
			...
			processBA.setLastException(e202); //BA.debugLineNum = 245;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
