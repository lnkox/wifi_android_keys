...
_cur_but_state = (int) (_cur_but_state+1);
			...
			processBA.setLastException(e215); //BA.debugLineNum = 255;BA.debugLine="proces_error(LastException.Message & \"add_key_to";
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()),"send_to_dev",(Object)(_data));
			...
			processBA.setLastException(e300); //BA.debugLineNum = 351;BA.debugLine="proces_error(LastException.Message & \"reset_dev\"";
...
_conect_tmout = (int) (3);
			...
			processBA.setLastException(e176); //BA.debugLineNum = 213;BA.debugLine="proces_error(LastException.Message & \"set_ris\")";
...
_butstate[_tmind] = anywheresoftware.b4a.keywords.Common.False;
			...
			processBA.setLastException(e267); //BA.debugLineNum = 317;BA.debugLine="proces_error(LastException.Message & \"tbuts_clic";
...
_prs_but = _tmind;
			...
			processBA.setLastException(e250); //BA.debugLineNum = 299;BA.debugLine="proces_error(LastException.Message & \"tbuts_cdow";
