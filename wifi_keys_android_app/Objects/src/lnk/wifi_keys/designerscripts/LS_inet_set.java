package lnk.wifi_keys.designerscripts;
import anywheresoftware.b4a.objects.TextViewWrapper;
import anywheresoftware.b4a.objects.ImageViewWrapper;
import anywheresoftware.b4a.BA;


public class LS_inet_set{
...
//BA.debugLineNum = 6;BA.debugLine="inet_server_txt.Width =100%x-inet_server_txt.Left"[inet_set/General script]
views.get("inet_server_txt").vw.setWidth((int)((100d / 100 * width)-(views.get("inet_server_txt").vw.getLeft())));
