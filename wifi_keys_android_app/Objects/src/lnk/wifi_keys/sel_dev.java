...
mostCurrent._activity.Finish();
			...
			processBA.setLastException(e18); //BA.debugLineNum = 33;BA.debugLine="proces_error(LastException.Message)";
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()),"send_to_dev",(Object)(_data));
			...
			processBA.setLastException(e28); //BA.debugLineNum = 44;BA.debugLine="proces_error(LastException.Message)";
_proces_error(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 12;BA.debugLine="Public dev_list As ListView";
...
public static String  _proces_error(String _msg) throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub proces_error(msg As String)";
 //BA.debugLineNum = 53;BA.debugLine="Msgbox(msg,\"error\")";
