...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e100);RDebugUtils.currentLine=1966095;
...
_udpsocket.Initialize(processBA,"UDP",(int) (1407),(int) (255));
			...
			processBA.setLastException(e18);RDebugUtils.currentLine=1703940;
...
mostCurrent._statemanager._savesettings(processBA);
			...
			processBA.setLastException(e72);RDebugUtils.currentLine=1835024;
...
mostCurrent._statemanager._savesettings(processBA);
			...
			processBA.setLastException(e82);RDebugUtils.currentLine=1900551;
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._inet_set.getObject()),"finish_him");
			...
			processBA.setLastException(e53);RDebugUtils.currentLine=1769505;
