...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,(Object)(mostCurrent._main.getObject()),"set_mqtt_state",(Object)(anywheresoftware.b4a.keywords.Common.False));
			...
			processBA.setLastException(e46);RDebugUtils.currentLine=786445;
 //BA.debugLineNum = 786445;BA.debugLine="proces_error(LastException.Message & \"mqtt_connec";
...
_objmqtt.Disconnect(processBA);
			...
			processBA.setLastException(e31);RDebugUtils.currentLine=720900;
 //BA.debugLineNum = 720900;BA.debugLine="proces_error(LastException.Message & \"mqtt_discon";
...
try {RDebugUtils.currentLine=655362;
 //BA.debugLineNum = 655362;BA.debugLine="objMqtt.JavaDebug = True";
_objmqtt.JavaDebug = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=655363;
 //BA.debugLineNum = 655363;BA.debugLine="objMqtt.CleanSession = True";
_objmqtt.CleanSession = anywheresoftware.b4a.keywords.Common.True;
RDebugUtils.currentLine=655364;
 //BA.debugLineNum = 655364;BA.debugLine="objMqtt.Initialize(\"oMqtt\")";
_objmqtt.Initialize(processBA,"oMqtt");
RDebugUtils.currentLine=655365;
 //BA.debugLineNum = 655365;BA.debugLine="objMqtt.KeepAliveInterval =3";
_objmqtt.KeepAliveInterval = (int) (3);
 } 
       catch (Exception e24) {
			processBA.setLastException(e24);RDebugUtils.currentLine=655367;
 //BA.debugLineNum = 655367;BA.debugLine="proces_error(LastException.Message & \"mqtt_init\")";
...
RDebugUtils.currentLine=917506;
 //BA.debugLineNum = 917506;BA.debugLine="ToastMessageShow(\"MQTT connect error\",False)";
...
try {RDebugUtils.currentLine=1376258;
 //BA.debugLineNum = 1376258;BA.debugLine="result=result.Replace(Chr(0),\"\")";
_result = _result.replace(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0))),"");
RDebugUtils.currentLine=1376259;
 //BA.debugLineNum = 1376259;BA.debugLine="result=result.Replace(\"}{\",\",\")";
_result = _result.replace("}{",",");
RDebugUtils.currentLine=1376260;
 //BA.debugLineNum = 1376260;BA.debugLine="Dim JSON As JSONParser";
_json = new anywheresoftware.b4a.objects.collections.JSONParser();
RDebugUtils.currentLine=1376261;
 //BA.debugLineNum = 1376261;BA.debugLine="Dim Mapar As Map";
_mapar = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=1376262;
 //BA.debugLineNum = 1376262;BA.debugLine="JSON.Initialize(result)";
_json.Initialize(_result);
RDebugUtils.currentLine=1376263;
 //BA.debugLineNum = 1376263;BA.debugLine="Mapar = JSON.NextObject";
_mapar = _json.NextObject();
RDebugUtils.currentLine=1376265;
 //BA.debugLineNum = 1376265;BA.debugLine="If Mapar.ContainsKey(\"yourid\")=False Then Return";
if (_mapar.ContainsKey((Object)("yourid"))==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
RDebugUtils.currentLine=1376266;
 //BA.debugLineNum = 1376266;BA.debugLine="Dim tmpid As String=Mapar.Get(\"yourid\")";
_tmpid = BA.ObjectToString(_mapar.Get((Object)("yourid")));
RDebugUtils.currentLine=1376267;
 //BA.debugLineNum = 1376267;BA.debugLine="If tmpid.EqualsIgnoreCase(CM.myid)=False Then Ret";
if (_tmpid.equalsIgnoreCase(mostCurrent._cm._myid)==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
RDebugUtils.currentLine=1376269;
 //BA.debugLineNum = 1376269;BA.debugLine="If Mapar.ContainsKey(\"rssi\")=True Then   CallSubD";
...
RDebugUtils.currentLine=1376270;
 //BA.debugLineNum = 1376270;BA.debugLine="If Mapar.ContainsKey(\"namedev\")=True Then CallSub";
...
RDebugUtils.currentLine=1376271;
 //BA.debugLineNum = 1376271;BA.debugLine="If Mapar.ContainsKey(\"ssid_ap\")=True Then CallSub";
...
RDebugUtils.currentLine=1376272;
 //BA.debugLineNum = 1376272;BA.debugLine="If Mapar.ContainsKey(\"ssid_sta\")=True Then CallSu";
...
RDebugUtils.currentLine=1376273;
 //BA.debugLineNum = 1376273;BA.debugLine="If Mapar.ContainsKey(\"key_id\")=True Then set_key_";
if (_mapar.ContainsKey((Object)("key_id"))==anywheresoftware.b4a.keywords.Common.True) { 
_set_key_set(_mapar);};
RDebugUtils.currentLine=1376274;
 //BA.debugLineNum = 1376274;BA.debugLine="If Mapar.ContainsKey(\"font_size\")=True Then set_k";
...
RDebugUtils.currentLine=1376276;
 //BA.debugLineNum = 1376276;BA.debugLine="If Mapar.ContainsKey(\"save_ok\")=True Then";
if (_mapar.ContainsKey((Object)("save_ok"))==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=1376277;
 //BA.debugLineNum = 1376277;BA.debugLine="ToastMessageShow (\"Saved\",False)";
...
RDebugUtils.currentLine=1376278;
 //BA.debugLineNum = 1376278;BA.debugLine="If (CM.toint (Mapar.Get (\"save_ok\"))=1) Then";
if ((mostCurrent._cm._toint(processBA,BA.ObjectToString(_mapar.Get((Object)("save_ok"))))==1)) { 
RDebugUtils.currentLine=1376279;
 //BA.debugLineNum = 1376279;BA.debugLine="CallSubDelayed(AP_SET,\"finish_him\")";
...
RDebugUtils.currentLine=1376281;
 //BA.debugLineNum = 1376281;BA.debugLine="If (CM.toint (Mapar.Get (\"save_ok\"))=2) Then";
if ((mostCurrent._cm._toint(processBA,BA.ObjectToString(_mapar.Get((Object)("save_ok"))))==2)) { 
RDebugUtils.currentLine=1376282;
 //BA.debugLineNum = 1376282;BA.debugLine="CallSubDelayed(STA_SET,\"finish_him\")";
...
RDebugUtils.currentLine=1376284;
 //BA.debugLineNum = 1376284;BA.debugLine="If (CM.toint (Mapar.Get (\"save_ok\"))=3) Then";
if ((mostCurrent._cm._toint(processBA,BA.ObjectToString(_mapar.Get((Object)("save_ok"))))==3)) { 
RDebugUtils.currentLine=1376285;
 //BA.debugLineNum = 1376285;BA.debugLine="CallSubDelayed(KEY_SET,\"finish_him\")";
...
RDebugUtils.currentLine=1376286;
 //BA.debugLineNum = 1376286;BA.debugLine="CallSubDelayed(sel_dev,\"load_keys\")";
...
RDebugUtils.currentLine=1376288;
 //BA.debugLineNum = 1376288;BA.debugLine="If (CM.toint (Mapar.Get (\"save_ok\"))=4) Then";
if ((mostCurrent._cm._toint(processBA,BA.ObjectToString(_mapar.Get((Object)("save_ok"))))==4)) { 
RDebugUtils.currentLine=1376289;
 //BA.debugLineNum = 1376289;BA.debugLine="CallSubDelayed(INET_SET,\"finish_him\")";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._inet_set.getObject()),"finish_him");
 };
 };
 } 
       catch (Exception e123) {
			processBA.setLastException(e123);RDebugUtils.currentLine=1376293;
 //BA.debugLineNum = 1376293;BA.debugLine="proces_error(LastException.Message & \"process_jso";
...
mostCurrent._statemanager._savesettings(processBA);
			...
			processBA.setLastException(e142);RDebugUtils.currentLine=1441808;
 //BA.debugLineNum = 1441808;BA.debugLine="proces_error(LastException.Message & \"set_key_se";
...
mostCurrent._statemanager._savesettings(processBA);
			...
			processBA.setLastException(e152);RDebugUtils.currentLine=1507335;
 //BA.debugLineNum = 1507335;BA.debugLine="proces_error(LastException.Message & \"set_key_in";
...
try {RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="Dim msg As String";
_msg = "";
RDebugUtils.currentLine=1572867;
 //BA.debugLineNum = 1572867;BA.debugLine="Dim JSONGenerator As JSONGenerator";
_jsongenerator = new anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator();
RDebugUtils.currentLine=1572868;
 //BA.debugLineNum = 1572868;BA.debugLine="data.Put (\"dev_name\",StateManager.GetSetting2(\"cu";
_data.Put((Object)("dev_name"),(Object)(mostCurrent._statemanager._getsetting2(processBA,"cur_dev_name","none")));
RDebugUtils.currentLine=1572869;
 //BA.debugLineNum = 1572869;BA.debugLine="data.Put (\"myid\",CM.myid)";
_data.Put((Object)("myid"),(Object)(mostCurrent._cm._myid));
RDebugUtils.currentLine=1572870;
 //BA.debugLineNum = 1572870;BA.debugLine="JSONGenerator.Initialize(data)";
_jsongenerator.Initialize(_data);
RDebugUtils.currentLine=1572871;
 //BA.debugLineNum = 1572871;BA.debugLine="msg = JSONGenerator.ToString";
_msg = _jsongenerator.ToString();
RDebugUtils.currentLine=1572872;
 //BA.debugLineNum = 1572872;BA.debugLine="If CM.connect_type=True Then";
if (mostCurrent._cm._connect_type==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=1572873;
 //BA.debugLineNum = 1572873;BA.debugLine="Return send_to_dev_mqtt(msg)";
if (true) return _send_to_dev_mqtt(_msg);
 }else {
RDebugUtils.currentLine=1572875;
 //BA.debugLineNum = 1572875;BA.debugLine="Return send_to_dev_udp(msg)";
if (true) return _send_to_dev_udp(_msg);
 };
 } 
       catch (Exception e169) {
			processBA.setLastException(e169);RDebugUtils.currentLine=1572878;
 //BA.debugLineNum = 1572878;BA.debugLine="proces_error(LastException.Message & \"send_to_de";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e178);RDebugUtils.currentLine=1638406;
 //BA.debugLineNum = 1638406;BA.debugLine="proces_error(LastException.Message & \"send_to_dev";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e192);RDebugUtils.currentLine=1703946;
 //BA.debugLineNum = 1703946;BA.debugLine="proces_error(LastException.Message & \"send_to_dev";
...
_udpsocket.Initialize(processBA,"UDP",(int) (1407),(int) (255));
			...
			processBA.setLastException(e78);RDebugUtils.currentLine=1245188;
 //BA.debugLineNum = 1245188;BA.debugLine="proces_error(LastException.Message & \"udp_init\")";
...
_proces_json(_result,_packet.getHostAddress());
			...
			processBA.setLastException(e86);RDebugUtils.currentLine=1310725;
 //BA.debugLineNum = 1310725;BA.debugLine="proces_error(LastException.Message & \"udp_pack.ar";
