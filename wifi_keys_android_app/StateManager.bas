...
Sub GetSetting2(Key As String, DefaultValue As String) As String
...
'Sub GetSetting(Key As String) As String
...
Sub innerSaveState(v As View, list1 As List)
	...
	Else If v Is Button Then
		...
		Button1 = v
		data = Array As Object(Button1.Text,Button1.tag,Button1.Left,Button1.Top,Button1.Width,Button1.Height,Button1.Background)
...
Sub innerRestoreState(v As View, list1 As List)
	...
	Else If v Is Button Then
		...
		Button1.Left= data(2)
		Button1.Top= data(3)
		Button1.Width= data(4)
		Button1.Height= data(5)
		Button1.Background =data(6)
	Else If v Is Spinner Then
		Dim spinner1 As Spinner
		spinner1 = v
		data = getNextItem(list1)
