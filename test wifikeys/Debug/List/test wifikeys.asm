...
; 0000 0024     nb++;
	INC  R5
; 0000 0025     tmp=tmp|data;
	LDI  R30,0
	SBIC 0x10,4
	LDI  R30,1
	OR   R7,R30
; 0000 0026     if (nb==5) ind=tmp;
	LDI  R30,LOW(5)
	CP   R30,R5
	BRNE _0x4
	MOV  R4,R7
; 0000 0027     if (nb==6) proces_out(ind,data);
_0x4:
	LDI  R30,LOW(6)
	CP   R30,R5
	BRNE _0x5
...
_proces_out:
; .FSTART _proces_out
; 0000 002B if (i==0 && d==0) {PORTC=0; PORTD.7=0;}
	ST   -Y,R26
;	i -> Y+1
;	d -> Y+0
	LDD  R26,Y+1
...
; 0000 004E DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(128)
	OUT  0x11,R30
...
; 0000 0082 // INT1: Off
; 0000 0083 // INT2: Off
; 0000 0084 GICR|=(0<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,0x40
	OUT  0x3B,R30
; 0000 0085 MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(3)
	OUT  0x35,R30
; 0000 0086 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0087 GIFR=(0<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(64)
	OUT  0x3A,R30
; 0000 0088 
